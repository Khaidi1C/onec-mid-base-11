...
Процедура ПриСозданииНаСервере(Форма, ПараметрыРазмещения = Неопределено) Экспорт
	...
	//++ Юсупов Х. Добавление доп.реквизитов на формы документов 15.11.2023
	ЮХ_ДополнениеКомандФормы.ДополнитьФорму(Форма); 
	//-- Юсупов Х. Добавление доп.реквизитов на формы документов
